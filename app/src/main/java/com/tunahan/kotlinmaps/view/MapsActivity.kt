...
import com.tunahan.kotlinmaps.databinding.ActivityMapsBinding
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback,GoogleMap.OnMapLongClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sharedPreferences = this.getSharedPreferences("com.tunahan.kotlinmaps", MODE_PRIVATE)
        trackBoolean = false
    ...
    /*
        val eiffel = LatLng(48.85391, 2.25648)
